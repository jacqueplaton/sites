...
**Requer FFmpeg e FFprobe no PATH.** Verifique com `ffmpeg -version`. Se faltar: macOS `brew install ffmpeg` · Windows `winget install Gyan.FFmpeg` · Linux `sudo apt install ffmpeg`.
