...
class StatusLead(StrEnum):
    ...
    A especificação lista o funil em dois lugares com conjuntos diferentes
    (o Módulo 2 tem SITE_CRIADO e não tem REUNIAO; o Kanban do Módulo 9 tem
    REUNIAO/DEMO PRONTA e não tem NEGOCIACAO). Aqui vale a união dos dois,
    que é o único conjunto capaz de representar as duas telas sem perder
    etapa. SITE_CRIADO é a "DEMO PRONTA" do Kanban.
    """

    NOVO = "NOVO"
    QUALIFICADO = "QUALIFICADO"
    SITE_CRIADO = "SITE_CRIADO"
    ABORDAR = "ABORDAR"
    ABORDADO = "ABORDADO"
    RESPONDEU = "RESPONDEU"
