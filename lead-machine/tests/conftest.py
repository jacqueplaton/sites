...
_TMP = Path(tempfile.mkdtemp(prefix="leadmachine-testes-"))
...
from app.config import limpar_cache_config  # noqa: E402
from app.database import Base, SessionLocal, engine  # noqa: E402
from app.http_client import Resposta  # noqa: E402
