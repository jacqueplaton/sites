...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        self.user_agent: str = os.getenv(
            "LM_USER_AGENT",
            "LeadMachine/1.0 (+prospeccao-local)",
        )
...
PESOS_PADRAO: dict[str, int] = {
    ...
    "empresa_estabelecida": 5,
    "presenca_digital_fraca": 5,
    "site_profissional": -20,
    "aparentemente_inativa": -10,
    "poucos_sinais_operacao": -10,
}

LIMIARES_PADRAO: dict[str, float] = {
    # nº de avaliações acima do qual vale "muitas_avaliacoes"
    "avaliacoes_muitas": 20,
    # nota acima da qual vale "boa_nota"
    "nota_boa": 4.5,
    # nº de avaliações a partir do qual a empresa é considerada estabelecida
    "avaliacoes_estabelecida": 50,
    # nº máximo de canais digitais para considerar a presença fraca
    "canais_presenca_fraca": 1,
    # nº mínimo de sinais de operação esperado (contato, endereço, avaliações)
    "sinais_operacao_minimos": 2,
}
...
def config_padrao() -> dict[str, Any]:
    from app.niches import NICHOS_PADRAO
